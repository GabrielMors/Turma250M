...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        let window = UIWindow(windowScene: windowScene) // Imagine com se fosse a nossa telinha
        ...
        window.makeKeyAndVisible() // Tornando a chave da Window visivel
        self.window = window // Referenciando!!!
    }
